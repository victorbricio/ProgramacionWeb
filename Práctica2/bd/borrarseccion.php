...
<html lang="es" dir="ltr">
  ...
  <body>
	...
	<h2> Borrar una secci&oacute;n</h2>

	<!-- Formulario -->

	<section class="sectionNormal">
		<form action=borrarsecciongestion.php method=post>
			...
			<p>Est&aacute;s a punto de eliminar esta secci&oacute;n. ¿Quieres hacerlo efectivo?</p>
