...
<html lang="es" dir="ltr">
  ...
  <body>
	...
	<h2> Dar de alta un recurso </h2>

	<!-- Formulario -->

	<form action=altarecursogestion.php method=post onsubmit="return validate()">
		<section id="biblioteca">
			<input type=file name="imagen" id="imagen" />
			<p>Elige la imagen que va a representar al recurso</p>
		</section>
		...
		<section id="recursos">
			...
			<select name="seccion" id="seccion" size="1">
				<?php 
					...
					$consulta2 = "select *  from Seccion where biblioteca=:biblioteca";
		...
		<section id="biblioteca">
			<input type="submit" name="login" value="Crear" id="entrarFuera">
		</section>
	</form>
     </main>	
