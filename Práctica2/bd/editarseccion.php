...
<html lang="es" dir="ltr">
  ...
  <body>
	...
	<h2> Editar una secci&oacute;n</h2>

	<!-- Formulario -->

	<form action=editarsecciongestion.php method=post onsubmit="return validate()">
		<section class="sectionNormal">
			...
			<label>Nuevo nombre de la secci&oacute;n&nbsp;</label>
		...
		<section id="descripcion">
			...
			<input type=text name=descripcion id=desc></textarea><br>
		</section>
